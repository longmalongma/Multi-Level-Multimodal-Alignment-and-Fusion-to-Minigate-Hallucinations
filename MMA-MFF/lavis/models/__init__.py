...
from lavis.models.blip2_models.blip2_vicuna_instruct_clip2 import *
from lavis.models.blip2_models.blip2_vicuna_instruct_first_stage import *
# from lavis.models.blip2_models.blip2_vicuna_instruct_diffusion_mutiAlign import *
...
def load_model_and_preprocess(name, model_type, is_eval=False, device="cpu", memory_bank_length=0, num_frames=0):
    """
    ...
    # load model
    model = model_cls.from_pretrained(model_type=model_type, memory_bank_length=memory_bank_length, num_frames=num_frames)
